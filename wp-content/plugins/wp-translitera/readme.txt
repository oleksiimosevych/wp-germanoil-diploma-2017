...
= 161114 =
* optimized initialization (core)
* forced transliteration mode (functional)
* tested with WPML String Translation (compatibility)
...
* Security fix (core)
* Tested whith Wordpress 4.6 release and Wordpress 4.7alpha (compatibility)
