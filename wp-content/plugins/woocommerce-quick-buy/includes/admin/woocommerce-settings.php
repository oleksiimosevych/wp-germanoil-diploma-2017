...
class WooCommerce_Quick_Buy_Settings extends WC_Settings_Page {
	...
	public function get_general(){
		...
		$settings_array[] = array( 'name' => __( 'General Settings', WCQB_TXT ),'type' => 'title', 'desc' => __( 'The following options are used to configure WC Quick Buy Actions',WCQB_TXT ), 
	...
	public function get_button_style(){
		...
		$settings_array[] = array( 'name' => __( 'Quick Buy Button Settings', WCQB_TXT ),'type' => 'title', 'desc' => __( 'The following options are used to configure WC Quick Buy Button',WCQB_TXT ), 
