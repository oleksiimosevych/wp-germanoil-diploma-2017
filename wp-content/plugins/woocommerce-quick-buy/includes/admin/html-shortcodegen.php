...
<table id="wcqb_shortcodegen" class="widefat striped">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <input type="text" style="width: 50%;" id="button_label" name="button_label" value="<?php _e(" Quick Buy ",WCQB_TXT); ?>" />
            </td>
        </tr>
        ...
        <tr>
            <th></th>
            <td colspan="">
                <textarea name="result" id="wcshortcoderesult"> <?php _e("Generated Shortcode will be updated here",WCQB_TXT); ?> </textarea>
            </td>
        </tr>
    </tbody>
